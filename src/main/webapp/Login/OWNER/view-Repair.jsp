...
<html>
    <head>
        ...
        <title>View Repair Detail</title>
        <style>
            .center {
                display: block;
                margin: auto;
    ...
    <body>
        ...
        <article>
            ...
            <div>
                <p>Sorry for the inconvenience. We&rsquo;re performing some maintenance at the moment. <a href="${pageContext.request.contextPath}/Login/OWNER/repairList.jsp">Go Back</a> </p>
                <p>&mdash; The Millineum Z Tech Team</p>
            </div>
        </article>
    </body>
</html>
